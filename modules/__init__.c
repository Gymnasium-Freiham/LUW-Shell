...
{
    "distutils": {
        "name": "modules.__init__",
        "sources": [
            "modules\\__init__.py"
        ]
    },
    "module_name": "modules.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__modules
#define __PYX_HAVE_API__modules
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "modules" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "modules.__init__"
extern int __pyx_module_is_main_modules____init__;
int __pyx_module_is_main_modules____init__ = 0;
...
#define __pyx_kp_u_modules___init __pyx_string_tab[1]
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_modules(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_modules", 0);
  ...
  if (__pyx_module_is_main_modules____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_modules___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "modules")) {
      if (unlikely((PyDict_SetItemString(modules, "modules", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init modules", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init modules");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{16},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (75 bytes) */
const char* const cstring = "x\332%\214Q\016\2000\014Bo\344\025<\n\301\255&\215\335\314lw\177\253\343\003\036\taow\235&\276\001\3325\200b\332%\031\361\260\310\301r\001\215\331Sk\373Qg\373sL\332b\227\250rrZ~\204x\372\013yN$T";
...
const char* const bytes = "?modules.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
